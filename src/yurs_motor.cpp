#include "ros2_drv8320_hardware/yurs_motor.hpp"
...
using namespace ros2_drv8320_hardware;
...
PLUGINLIB_EXPORT_CLASS(ros2_drv8320_hardware::yurs_motor, hardware_interface::ActuatorInterface)
